  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      if (editingOrder) {
       ...
       const newOrderRef = await orderService.add(processedFormData);
      
      // 2. TRIGGER EMAIL AUTOMATICALLY
      const emailData = {
        userName: processedFormData.customerName,
        userEmail: processedFormData.customerEmail,
        _id: newOrderRef.id || "NEW",
      };
...
useEffect(() => {
  ...
  return (
   <div className="w-full h-auto bg-gray-900 p-4 md:p-6">
      {/* Header Section */}
